<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.categories.create') }}" class="bg-amber-500 text-white px-4 py-2 rounded-md font-semibold text-sm hover:bg-amber-600 transition shadow-sm flex items-center gap-2">
                            ...
                            <tr class="hover:bg-gray-50 transition duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <!-- Edit Button -->
                                        <a href="{{ route('admin.categories.edit', $category) }}" class="p-2 rounded-lg text-blue-600 hover:text-blue-900 bg-blue-50 hover:bg-blue-100 transition" title="تعديل">
